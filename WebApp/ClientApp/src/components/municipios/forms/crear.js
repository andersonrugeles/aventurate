     ...
     CreateMunicipio(e) {
       e.preventDefault();
        const {
         ...
         file.append('URLImagen10', municipio.URLImagen6);
         file.append('URLImagen11', municipio.URLImagen7);
         file.append('URLImagen12', municipio.URLImagen8);
         file.append('URLImagen13', municipio.URLImagen9);
         file.append('URLImagen14', municipio.URLImagen9);
                    ...
                    <Form onSubmit={this.CreateMunicipio} >
                        ...
                        <ListGroup className="pt-1 pb-2">
                            ...
                            <ListGroup.Item>
                                ...
                                <Form.Group md="6" >
                                    <Form.Group as={Col} >
                                        <Form.Control type="text" name="URLImagen10" value={municipio.URLImagen9} onChange={this.InputChange} className="pz-input" placeholder="URLImagen10" />
                                    </Form.Group>
                                    <Form.Group as={Col} >

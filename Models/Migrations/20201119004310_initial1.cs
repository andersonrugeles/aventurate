        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Festividades = table.Column<string>(nullable: false),
                    ...
                    QueHacer = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(nullable: false),
                    Descripcion = table.Column<string>(nullable: false),
                    Anexo = table.Column<string>(nullable: false),
                    ...
                    NombreInstagram = table.Column<string>(nullable: true),
                    FacebookUrl = table.Column<string>(nullable: true),
                    NombreFacebook = table.Column<string>(nullable: true),
                    Correo = table.Column<string>(nullable: true),
                    Tips = table.Column<string>(nullable: true),
                    Pagina = table.Column<string>(nullable: true),
                    TwitterUrl = table.Column<string>(nullable: true),
                    NombreTwitter = table.Column<string>(nullable: true),
                    IdMunicipio = table.Column<int>(nullable: false),
                    IdCategoriaSubcategoria = table.Column<int>(nullable: false),
                    IdEmpresa = table.Column<int>(nullable: false),
                    IdTipoSede = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
